...
- **Main Section Headings (Services, Case Studies, In Development)**: Standardized section headings globally on mobile viewports to start at `text-3xl` (scaled from `text-4xl`) in [ServicesSection.tsx](file:///c:/Development/yq-digital-portfolio-main/src/components/ServicesSection.tsx), [WorkSection.tsx](file:///c:/Development/yq-digital-portfolio-main/src/components/WorkSection.tsx), and [LabsSection.tsx](file:///c:/Development/yq-digital-portfolio-main/src/components/LabsSection.tsx), matching the uniform `text-3xl md:text-5xl` typography.
